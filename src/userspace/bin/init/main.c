...
// /* ---- minimal syscall numbers (adjust to your table) ---- */
// #define SYS_epoll_create1 291
// #define SYS_epoll_ctl     233
// #define SYS_epoll_wait    232
// #define SYS_eventfd2      290

// /* ---- minimal epoll / eventfd constants ---- */
...
// #define EFD_CLOEXEC     0x02000000
// #define EFD_NONBLOCK    0x00000800

// /* ---- struct epoll_event (Linux‑compatible layout) ---- */
// struct epoll_event {
//     uint32_t events;
//     union {
//         uint64_t u64;
...
// static inline long my_syscall4(long nr,
//                                long a0,
//                                long a1,
//                                long a2,
//                                long a3)
...
// static inline long my_syscall2(long nr, long a0, long a1)
// {
//     long ret;
//     __asm__ volatile (
//         "syscall"
...
// /* ---- user‑space wrappers that MUSL would normally provide ---- */

// int epoll_create1(int flags)
// {
//     return (int)my_syscall2(SYS_epoll_create1, flags, 0);
// }

// int eventfd(unsigned int initval, int flags)
// {
//     return (int)my_syscall2(SYS_eventfd2, (long)initval, (long)flags);
// }

// int epoll_ctl(int epfd, int op, int fd, struct epoll_event *ev)
// {
//     return (int)my_syscall4(SYS_epoll_ctl,
//                             epfd,
//                             op,
//                             fd,
//                             (long)ev);
...
// {
//     return (int)my_syscall4(SYS_epoll_wait,
//                             epfd,
//                             (long)events,
//                             maxevents,
//                             timeout);
// }
// ******************************************************************************************************************************************************
// // luma_syscalls.c (userspace)

// #include <stdint.h>
// #include <sys/epoll.h>
// #include <sys/eventfd.h>

// // Use your kernel's syscall numbers:
// #define SYS_epoll_create1 291
// #define SYS_eventfd2      290
// #define SYS_epoll_ctl     233
// #define SYS_epoll_wait    232
...
// /* ---- OVERRIDES that Wayland/musl will call ---- */
...
// int main(void)
// {
//     printf("[Userspace] epoll/eventfd test start\n");

//     syscall6(999, 11, 22, 33, 44, 55, 66);  /* your SYS_test */

//     int epfd = epoll_create1(EPOLL_CLOEXEC);
//     printf("[Userspace] epoll_create1 -> %d\n", epfd);

//     int efd  = eventfd(0, EFD_NONBLOCK | EFD_CLOEXEC);
//     printf("[Userspace] eventfd -> %d\n", efd);

//     struct epoll_event ev;
//     ev.events   = EPOLLIN;
//     ev.data.u64 = 0x1234;

//     int r = epoll_ctl(epfd, EPOLL_CTL_ADD, efd, &ev);
//     printf("[Userspace] epoll_ctl(ADD) -> %d\n", r);

//     struct epoll_event out_ev;
//     r = epoll_wait(epfd, &out_ev, 1, 0);
//     printf("[Userspace] epoll_wait -> %d\n", r);
